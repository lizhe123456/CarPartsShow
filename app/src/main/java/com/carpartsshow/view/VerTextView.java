...
public class VerTextView extends TextSwitcher implements
    ...
    private ArrayList<HomePageBean.ListNoticeBean> textList;
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case FLAG_START_AUTO_SCROLL:
                        if (textList.size() > 0) {
                            currentId++;
                            setText(textList.get(currentId % textList.size()).getNotice_Title());
                        }
     ...
     * @param titles
     */
    public void setTextList(ArrayList<HomePageBean.ListNoticeBean> titles) {
        textList.clear();
