package com.carpartsshow.widgets;
...
public class CurrencyDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.app_dialog_currency);
    ...
    private void show(CurrencyDialog dialog){
    ...
    private CurrencyDialog(Context context) {
